...
<section class="experience-container">
  ...
  <div class="experience-card">
    <h3>株式会社CAMPFIRE</h3>
    <p>期間: 2016年 - 現在</p>
    <p>業務内容: 前職の経営悪化によりサーバーサイドエンジニアとして転職し、ジョイン当初はCakePHPでできたアプリケーションの開発に関わっていました。Ruby/Railsでのリプレイスを経て、SREに転向、SREチームの立ち上げとリード、マネージャーを経験しました。その後開発チームのマネージャーを経てVPoE/プロダクト開発部長に就任。マネジメントや採用、IT統制など幅広く関わっています。</p>
  </div>
  <div class="experience-card">
    <h3>株式会社ワンズ</h3>
    <p>期間: 2015年 - 2016年</p>
